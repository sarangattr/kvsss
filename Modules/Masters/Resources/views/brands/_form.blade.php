<div class="row mt-2">
    <div class="col-md-6">
        ...
        {!! Form::text('name', null, ['class' => 'form-control', 'placeholder' => 'Brand name', 'required', 'maximumLength' => 100, 'minimumLength' => 2]) !!}
...
<div class="row mt-2">
    <div class="col-md-6">
        ...
        {!! Form::textarea('description',  null, ['class' => 'form-control', 'placeholder' => 'Brand Description']) !!}
